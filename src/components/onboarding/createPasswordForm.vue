  ...
  formRef.value?.validate(
    (errors: Array<FormValidationError> | undefined) => {
      ...
      userStore.ChangeDefaultPassword({
        token: props.userActivationParams?.token as string,
        customerReferece: props.userActivationParams?.customerReferece as string,
        email: props.userActivationParams?.email as string,
...
<template>
  <div class="form-container">
    ...
    <section class="form-body">
      ...
      <div
        v-else
        class="onboarding-form-footer"
      >
        <n-text type="success" ghost>Password Changed successfully!</n-text>
