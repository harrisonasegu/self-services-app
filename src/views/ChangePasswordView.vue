...
import ChangePasswordForm from '@/components/onboarding/changePasswordForm.vue'
...
async function updateUserActivationParams() {
  const changePasswordParams_ = routeParams.changePasswordParams as string
  const paramData = JSON.parse(atob(changePasswordParams_)) as CustomerActivation_Interface

  // update user activation params
  changePasswordParams.email = paramData.email
  changePasswordParams.token = paramData.token
  changePasswordParams.customerReferece = paramData.customerReferece
}
  ...
  <div class="page-view">
    <section class="overlay">
      ...
      <section class="form-container">
        <ChangePasswordForm
          :change-password-params="changePasswordParams"
        />
      </section>
    </section>
  </div>
